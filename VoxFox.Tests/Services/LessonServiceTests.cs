...
public class LessonServiceTests
{
    ...
    private readonly Mock<ICertificateService> _certificateMock = new();
    private readonly Mock<IAchievementService> _achievementMock = new();
    ...
    public LessonServiceTests()
    {
        ...
        // CheckAndAwardAsync по умолчанию возвращает пустой список
        _achievementMock
            .Setup(a => a.CheckAndAwardAsync(It.IsAny<Guid>(), It.IsAny<AchievementTrigger>()))
            .ReturnsAsync(new List<NewAchievementDto>());
