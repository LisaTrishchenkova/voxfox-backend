...
public interface ICourseService
{
	...
	Task<bool> DeleteCourseAsync(Guid id, Guid userId, bool isAdmin = false, string? reason = null);
	Task<ServiceResult<bool>> RestoreCourseAsync(Guid id);
	Task<ServiceResult<bool>> UnpublishCourseAsync(Guid id, string? reason = null);
