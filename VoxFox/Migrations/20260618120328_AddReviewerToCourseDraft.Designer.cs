...
namespace VoxFox.Migrations
{
    ...
    [Migration("20260618120328_AddReviewerToCourseDraft")]
    partial class AddReviewerToCourseDraft
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("VoxFox.Models.Entities.Achievement", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid")
                    ...
                    b.HasData(
                        ...
                        new
                        {
                            ...
                            Code = "first_course",
                            Description = "Завершил свой первый курс",
                            Icon = "🎓",
                            Title = "Выпускник"
                        },
                        new
                        ...
                        new
                        {
                            ...
                            Description = "Получил первый сертификат",
                            Icon = "📜",
                            Title = "Дипломант"
                        },
                        new
                        {
                            ...
                            Code = "first_review",
                            Description = "Оставил свой первый отзыв",
                            Icon = "✍️",
                            Title = "Критик"
                        },
                        new
                        {
                            ...
                            Code = "perfect_score",
                            Description = "Завершил курс с прогрессом 100%",
                            Icon = "⭐",
                            Title = "Отличник"
                        });
                });
            ...
            modelBuilder.Entity("VoxFox.Models.Entities.CourseDraft", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid")
            ...
            modelBuilder.Entity("VoxFox.Models.Entities.CourseReviewHistory", b =>
                {
                    ...
                    b.ToTable("CourseReviewHistories");
                });

            modelBuilder.Entity("VoxFox.Models.Entities.DraftLesson", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid")
                    ...
                    b.ToTable("DraftLessons");
                });

            modelBuilder.Entity("VoxFox.Models.Entities.DraftSection", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid")
                    ...
                    b.Property<Guid?>("OriginalSectionId")
                        .HasColumnType("uuid");
                    ...
                    b.ToTable("DraftSections");
                });

            modelBuilder.Entity("VoxFox.Models.Entities.DraftTag", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid")
            ...
            modelBuilder.Entity("VoxFox.Models.Entities.DraftTask", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid")
            ...
            modelBuilder.Entity("VoxFox.Models.Entities.Transaction", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid")
            ...
            modelBuilder.Entity("VoxFox.Models.Entities.UserAchievement", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid")
            ...
            modelBuilder.Entity("VoxFox.Models.Entities.CourseReviewHistory", b =>
                {
                    ...
                    b.HasOne("VoxFox.Models.Entities.User", "Moderator")
                        .WithMany()
            ...
            modelBuilder.Entity("VoxFox.Models.Entities.DraftLesson", b =>
                {
                    b.HasOne("VoxFox.Models.Entities.DraftSection", "DraftSection")
                        .WithMany("Lessons")
                        .HasForeignKey("DraftSectionId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.Navigation("DraftSection");
                });

            modelBuilder.Entity("VoxFox.Models.Entities.DraftSection", b =>
                {
                    b.HasOne("VoxFox.Models.Entities.CourseDraft", "Draft")
                        .WithMany("Sections")
            ...
            modelBuilder.Entity("VoxFox.Models.Entities.DraftTask", b =>
                {
                    b.HasOne("VoxFox.Models.Entities.DraftLesson", "DraftLesson")
                        .WithMany("Tasks")
                        .HasForeignKey("DraftLessonId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.Navigation("DraftLesson");
                });
            ...
            modelBuilder.Entity("VoxFox.Models.Entities.Transaction", b =>
                {
                    ...
                    b.HasOne("VoxFox.Models.Entities.Transaction", "OriginalTransaction")
                        .WithMany()
            ...
            modelBuilder.Entity("VoxFox.Models.Entities.UserAchievement", b =>
                {
                    b.HasOne("VoxFox.Models.Entities.Achievement", "Achievement")
